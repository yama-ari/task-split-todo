...
ActiveRecord::Schema[7.2].define(version: 2025_09_17_013631) do
  ...
  create_table "daily_activities", force: :cascade do |t|
    ...
    t.date "date"
    t.boolean "morning_logged_in", default: false, null: false
    t.boolean "evening_logged_in", default: false, null: false
